    ...
    return number_format ($nilai, 0, ',', '.');
            ...
            <form method="POST">
                ...
                <input type="hidden" class="form-control" value="<?php echo $tot_bayar; ?>" id="hargatotal" readonly>
                    ...
                    <label class="col-sm-4 col-form-label col-form-label-sm"><b>Kembalian</b></label>
                        <div class="col-sm-8 mb-2">
                            <input type="number" class="form-control form-control-sm"
                            name="kembalianFix" id="total1">
                    </div>
                </div>
  ...
  <div class="col-md-6 mb-3">
      ...
      <div class="text-right mt-3">
          <form method="POST">
            ...
            <button class="btn btn-purple btn-sm" name="simpankeranjang" type="submit"><i class="fa fa-check mr-1"></i> Selesai</button>
          </form>
      </div>
      <?php
               if(isset($_POST['simpankeranjang'])){    
                    ...
                    // $query = "INSERT INTO laporanku set id_cart='', kode_barang='$kode_barang', nama_barang='$nama_barang', harga_barang='$harga_barang', quantity='$quantity', subtotal='$subtotal', tgl_input='$tgl', no_transaksi='$no_transaksi', bayar='$bayar', kembalian='$kembalian'";
                    // mysqli_query($conn, $query);

                    // $query = "INSERT INTO `laporanku` (`id_cart`, `kode_barang`, `nama_barang`, `harga_barang`, `quantity`, `subtotal`, `tgl_input`, `no_transaksi`, `bayar`, `kembalian`) VALUES (NULL, '$kode_barang', '$nama_barang', '$harga_barang', '$quantity', '$subtotal', '$tgl', '$no_transaksi', '$bayar', '$kembalian')";
                    // mysqli_query($conn, $query);
